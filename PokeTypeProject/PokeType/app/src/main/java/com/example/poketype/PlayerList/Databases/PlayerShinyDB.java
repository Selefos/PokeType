...
public class PlayerShinyDB extends SQLiteOpenHelper
{
    public static final String DATABASE_NAME = "PlayerShiny.db";
    public static String TABLE_PLAYER = "Player_Name";

    public static final String COL_1 = "ID";
    public static final String COL_2 = "POKEMONNAME";
    public static final String COL_3 = "IMAGE_S";

    public PlayerShinyDB(@Nullable Context context)
    {
    ...
    public boolean insertStringImageToTable(String playerName, String name, byte[] image_s)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        playerValues.put(COL_3, image_s);
    ...
    public Cursor getImageforGrid(String TableName, String imageName)
    {
        ...
        String selectQuery = "SELECT * FROM " + TableName;
        String[] getData = {PlayerShinyDB.COL_3};
        String select = PlayerShinyDB.COL_2 + " LIKE ?";
        String[] selection = {imageName};
        Cursor cursor = db.query(PlayerShinyDB.TABLE_PLAYER, getData, select, selection, null, null, null);
